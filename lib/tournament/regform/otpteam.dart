...
postSingle( ) async {
                            ...
                            var request = http.MultipartRequest(
                              ...
                              request.fields['Email'] = jsonData["teamEmailA"];
                              request.fields['OTP'] = jsonData["teamOTP"].toString();
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "ส่งรหัสยืนยันการสมัครไปยังอีเมล : ${jsonData["teamEmailA"]}", //รับตัวแปรอีเมลเข้ามาใส่
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            var request = http.MultipartRequest(
                              'POST',
                              Uri.parse("$ipaddress/verifyteam"),
                                    );
                                    //team
                              request.fields['teamName'] = jsonData["teamName"];
                              request.fields['NameAgent'] = jsonData["NameAgent"];
                              request.fields['LnameAgent'] = jsonData["LnameAgent"];
                              request.fields['teamPhoneA'] = jsonData["teamPhoneA"];
                              request.fields['teamEmailA'] = jsonData["teamEmailA"];
                              request.fields['uniID'] = jsonData["uniID"];
                              request.fields['teamfile'] = jsonData["teamfile"];
                              request.fields['tnmID'] = jsonData["tnmID"];

                              //player
                              for(var i=0;i<jsonData["values"].length;i++){
                              request.fields['playerFName'] = jsonData["values"][i][0];
                              request.fields['playerLName'] = jsonData["values"][i][1];
                              request.fields['playerGender'] = jsonData["values"][i][2];
                              request.fields['playerBirthday'] = jsonData["values"][i][3];
                              request.fields['playerPhone'] = jsonData["values"][i][4];
                              request.fields['playerEmail'] = jsonData["values"][i][5];
                              request.fields['facultyID'] = jsonData["values"][i][6];
                              request.fields['playerIDCard'] = jsonData["values"][i][7];
                              request.fields['playerFile'] = jsonData["values"][i][8];
                              request.fields['detailDoc'] = jsonData["values"][i][9];
                              }

                              request.fields['OTP'] = jsonData["teamOTP"].toString();
                              request.fields['teamOTP'] = fronOTP;
                          ...
                          if(fronOTP == jsonData["teamOTP"].toString() ){
                            postTeam();
                          }else{
